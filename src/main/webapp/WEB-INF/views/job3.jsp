...
<body>
	<div id="dialog-info">
   		<div class="bs-name"><div class="name">회사 이름</div></div>
      	<div id="result-main">지도에 표시된 정보를 클릭하세요</div>
      	<div id="go-back-main">다른 서비스 이용하기</div>
	</div>
   	<div id="dialog" style="display:none;">
      <div class="bs-name">회사 이름<span class="dialog-close">X</span></div>
      <div id="type"></div>
      <div id="address"></div>
      <div id="salary"></div>
      <div id="deadline"></div>
   ...
   <script>
      ...
      $(document).on('click', '#go-back-main', function(){
         location.href = 'http://localhost:8080/app/service';
      });
