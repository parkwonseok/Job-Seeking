...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/job2.js"></script>
</head>
<body>
	...
	<div class="input-container">
		<form class="ic-form" action="${pageContext.request.contextPath}/job3" method="get">
			<input class="ic-input" type="text" placeholder="직종을 말씀해주세요" name="job">
